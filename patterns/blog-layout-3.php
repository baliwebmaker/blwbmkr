...
<!-- wp:query {"query":{"perPage":"4","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list","columns":2},"align":"full","className":"blwbmkr-blog-layout","layout":{"inherit":true}} -->
<div class="wp-block-query alignfull blwbmkr-blog-layout"><!-- wp:heading {"textColor":"primary","fontSize":"small"} --><h2 class="wp-block-heading has-primary-color has-text-color has-small-font-size"><?php echo esc_html_x( 'Latest', 'sample content', 'blwbmkr' ); ?></h2>
<!-- /wp:heading -->
