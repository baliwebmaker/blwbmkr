 ...
 * Slug: blwbmkr/footer-links-basic
 * Inserter: no
 *
 * @package blwbmkr
 * @since 1.0.0
...
<div class="wp-block-group">
<!-- wp:paragraph {"fontSize":"extra-small"} --><p class="has-extra-small-font-size"><?php echo __( 'Copyright', 'blwbmkr' ) . ' ' . date_i18n( _x( 'Y', 'copyright date format', 'blwbmkr' ) ); ?></p><!-- /wp:paragraph -->
