...
?>
<!-- wp:group {"align":"wide","layout":{"inherit":true},"className":"blwbmkr-pattern-header-image"} --><div class="wp-block-group alignwide blwbmkr-pattern-header-image">
...
<div class="wp-block-media-text__content"><!-- wp:heading {"className":"is-style-blwbmkr-text-shadow","fontSize":"xx-large"} -->
<h2 class="wp-block-heading is-style-blwbmkr-text-shadow has-xx-large-font-size"><?php echo _x( '<strong>Create your </strong><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-color">website</mark><strong> with blocks.</strong>', 'sample content', 'blwbmkr' ); ?></h2>
<!-- /wp:heading -->
