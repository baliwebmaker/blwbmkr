...
<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html_x( 'Heading', 'sample content', 'blwbmkr' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><?php echo esc_html_x( 'Sample content. Replace the text with your own content.', 'sample content', 'blwbmkr' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link has-dark-blue-background-color has-background"><?php echo esc_html_x( 'Button', 'sample content', 'blwbmkr' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
<!-- wp:column -->
