 ...
 * Slug: blwbmkr/testimonial-with-images
...
<blockquote class="wp-block-quote has-text-align-center"><p><?php echo esc_html_x( 'Add your testimonial here', 'sample content', 'blwbmkr' ); ?></p><cite><em><?php echo esc_html_x( 'Customer name', 'sample content', 'blwbmkr' ); ?></em></cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:column -->
<!-- wp:column -->
...
<!-- /wp:image -->
<!-- wp:quote {"align":"center"} -->
<blockquote class="wp-block-quote has-text-align-center"><p><?php echo esc_html_x( 'Add your testimonial here', 'sample content', 'blwbmkr' ); ?></p><cite><em><?php echo esc_html_x( 'Customer name', 'sample content', 'blwbmkr' ); ?>
</em></cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:column -->
<!-- wp:column -->
