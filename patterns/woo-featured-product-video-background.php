 ...
 * Slug: blwbmkr/featured-product-video-background
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'Add your custom product details here. To add the product video background, select the cover block and Add Media.', 'sample content', 'blwbmkr' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- wp:spacer {"height":"60px"} -->
