...
?>
<!-- wp:pattern {"slug":"blwbmkr/circular-image-with-heading"} /-->
<!-- wp:spacer -->
<div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
<!-- wp:pattern {"slug":"blwbmkr/woo-featured-products-two-columns"} /-->
<!-- wp:spacer -->
<div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
...
<h2 class="wp-block-heading has-primary-color has-text-color has-small-font-size"><?php echo esc_html_x( 'Featured', 'sample content', 'blwbmkr' ); ?></h2>
<!-- /wp:heading -->
...
<!-- /wp:column -->
<!-- wp:column {"width":"40%"} -->
<div class="wp-block-column" style="flex-basis:40%"><!-- wp:query {"query":{"perPage":"3","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list","columns":2},"align":"full","className":"blwbmkr-blog-layout","layout":{"inherit":true}} -->
<div class="wp-block-query alignfull blwbmkr-blog-layout">
<!-- wp:heading {"textColor":"primary","fontSize":"small"} --><h2 class="wp-block-heading has-primary-color has-text-color has-small-font-size"><?php echo esc_html_x( 'Latest', 'sample content', 'blwbmkr' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:post-template {"align":"wide"} -->
<!-- wp:group {"style":{"border":{"radius":"4px"},"color":{"background":"#f2f2f203"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
<div class="wp-block-group has-background" style="background-color:#f2f2f203;border-radius:4px"><!-- wp:post-featured-image {"isLink":true,"width":"100px","height":"100px","className":"is-style-blwbmkr-zoom-image is-style-blwbmkr-image-border-radius"} /-->
